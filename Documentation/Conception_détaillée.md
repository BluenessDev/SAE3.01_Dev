...
### Objectifs du Site Web Statique

L'Objectif de cette permière version est de présenter une maquette statique de ce site web. Il permettra aux client de savoir quelle seront les fonctionnalité que le site web sera doté.

#### Portée du Projet

C'est un site statique qui permetra de visualiser les fonctionnalité furtur l'application web

### Methode de Conception

Les pages du site web seront défini en tant que composant d'un plus grand composant qui est le site Web (Domaine du problème)
...
- Page de formulaire de connexion (form_connect.html) : En construction, accessible depuis la page d'accueil.
- Page de formulaire d'inscription (form_inscr.html) : En construction, accessible depuis la page d'accueil.

#### Version avec un Accès au Profil

- Page d'accueil (index.html) : Présentant une vidéo, un texte explicatif et un bouton de redirection vers la page de profil (profil.html).
- Page de profil (profil.html) : En construction, permettant la modification du mot de passe, de l'adresse e-mail, l'affichage d'informations sur le profil de l'utilisateur et un tableau de bord pour les tickets.
- Page de faux logs (log.html) : En construction, pour des connexions factices.

Les deux versions du site web auront deux sous-versions avec des chartes graphiques distinctes en fonction de deux logos fournis. Le projet évoluera au fil du temps pour inclure des fonctionnalités plus avancées, conformément au planning établi.
